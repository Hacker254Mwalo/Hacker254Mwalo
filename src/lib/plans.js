...
export const PLANS = [
  {
    ...
    tagline: 'Best for first-time investors starting small',
    audience: 'New investors',
    benefit: 'Low entry point with simple daily income tracking',
    badge: 'Starter',
  ...
  },
  {
    ...
    tagline: 'Built for users ready to step up their daily income',
    audience: 'Growing investors',
    benefit: 'Higher throughput with a familiar mid-tier entry point',
    badge: 'Fast Growth',
  ...
  },
  {
    ...
    tagline: 'Balanced package for steady scaling and repeat entries',
    audience: 'Consistency seekers',
    benefit: 'Balanced cost, stable returns, and repeatable access',
    badge: 'Balanced',
  ...
  },
  {
    ...
    tagline: 'Strong performer for users targeting higher 60-day income',
    audience: 'Momentum investors',
    benefit: 'Stronger projected revenue with premium hardware backing',
    badge: 'Most Popular',
  ...
  },
  {
    ...
    tagline: 'Designed for users who want bigger daily return potential',
    audience: 'Growth-focused users',
    benefit: 'Higher capacity and uninterrupted earning cycles',
    badge: 'High Demand',
  ...
  },
  {
    ...
    tagline: 'Premium package for users who want higher upside',
    audience: 'Premium investors',
    benefit: 'Specialized workloads with stronger premium pricing',
    badge: 'Premium',
  ...
  },
  {
    ...
    tagline: 'Built for larger investors who want stronger scale',
    audience: 'Scale builders',
    benefit: 'Multiple client streams with strong uptime positioning',
    badge: 'Advanced',
  ...
  },
  {
    ...
    tagline: 'Security-first package for larger protected capital cycles',
    audience: 'High-value accounts',
    benefit: 'Protected premium workloads with uptime assurance',
    badge: 'Secure Tier',
  ...
  },
  {
    ...
    tagline: 'High-capacity package for users who want maximum reach',
    audience: 'Large portfolio holders',
    benefit: 'Broad workload access across multiple datacenters',
    badge: 'Elite Scale',
