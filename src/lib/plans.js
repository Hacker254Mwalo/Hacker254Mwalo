...
export const PLANS = [
  {
    ...
    description: 'Your KSh 200 stake activates a micro-GPU node on our shared compute pool. Each cycle, your node processes lightweight AI inference tasks (image classification, text analysis) billed by enterprise clients. The revenue from these tasks is distributed back to node holders as your 24h yield — growing your balance automatically every day.',
    amount: 200,
    shareWorth: 'KSh 200',
    once: true,
  ...
  },
  {
    ...
    description: 'Your KSh 500 investment deploys a dedicated RTX 4090 rig that handles AI model training jobs for SaaS companies. Training jobs pay premium rates — your node runs continuous batch processing, and each completed cycle generates your daily yield. Higher GPU throughput = bigger payouts every 24 hours.',
    amount: 500,
    shareWorth: 'KSh 500',
    once: true,
  ...
  },
  {
    ...
    description: 'With KSh 1,000 you own a share in a 4-node A100 GPU cluster. The cluster handles parallel workloads — from language model serving to computer vision pipelines. Multiple simultaneous jobs mean multiple revenue streams. Your yield accumulates as each GPU completes its assigned compute contract.',
    amount: 1000,
  ...
  },
  {
    ...
    description: 'Your KSh 2,000 stake deploys into an 8-GPU H100 array dedicated to large language model fine-tuning. H100 tensor cores process AI workloads at 2x the speed of previous gen — meaning your node completes more contracts per cycle. Every completed contract credits your account with your daily compute yield.',
    amount: 2000,
  ...
  },
  {
    ...
    description: 'Your KSh 7,000 investment accesses a hybrid quantum-classical compute gateway. Quantum processors handle complex optimization problems (portfolio risk, logistics) that classical GPUs cannot solve efficiently. Premium pricing for these specialized tasks means higher daily yields than standard GPU compute.',
    amount: 7000,
  ...
  },
  {
    ...
    description: 'KSh 10,000 activates your share in a self-contained datacenter pod — complete with cooling, power redundancy, and networking. Housing 32 GPUs running continuous training and inference pipelines, this pod generates revenue from multiple enterprise clients simultaneously. Maximum uptime guarantees maximum yield accumulation.',
    amount: 10000,
  ...
  },
  {
    ...
    description: 'Your KSh 20,000 stake deploys into an encrypted, isolated compute environment handling high-security AI workloads — government contracts, financial modeling, and compliance-sensitive inference. Premium tier pricing with guaranteed 99.99% uptime SLA means your yield is protected and maximized every cycle.',
    amount: 20000,
  ...
  },
  {
    ...
    description: 'KSh 35,000 gives you a node in a grid-scale AI infrastructure spanning multiple datacenters. 128 GPU cores process federated learning, large-scale inference, and AI-as-a-Service workloads around the clock. Revenue streams from dozens of clients feed your yield daily — the more clients, the higher your payout.',
    amount: 35000,
  ...
  },
  {
    ...
    description: 'Your KSh 45,000 investment secures dedicated capacity reservation across our entire compute network — 256 GPU cores with custom workload scheduling and maximum priority. This means your node gets the highest-paying contracts first, every cycle. The highest yield tier available — designed for serious investors who want maximum daily returns.',
    amount: 45000,
